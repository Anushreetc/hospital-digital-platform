...
export const Navbar: React.FC<Props> = ({
  ...
  return (
    <header className="sticky top-0 z-40 bg-white/95 backdrop-blur-md border-b border-slate-200 shadow-sm transition-all">
      ...
      <div className="bg-slate-900 text-slate-200 text-[11px] sm:text-xs py-1 px-3 sm:px-4">
        <div className="max-w-[1440px] mx-auto flex justify-between items-center gap-2">
          ...
          <div className="flex items-center space-x-2 shrink-0">
            <span className="hidden md:inline text-slate-400 text-[11px]">NABH & NABL Accredited</span>
            <button
      ...
      <div className="max-w-[1440px] mx-auto px-3 sm:px-4 lg:px-6">
        <div className="flex items-center justify-between h-16 md:h-18 gap-2">
          {/* Logo & Brand */}
          <a href="#home" className="flex items-center space-x-2 shrink-0 group">
            <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-xl bg-gradient-to-tr from-blue-600 to-indigo-600 flex items-center justify-center text-white shadow-md shadow-blue-500/20 group-hover:scale-105 transition-transform">
              <HeartPulse className="w-4 h-4 sm:w-5 sm:h-5 text-white" />
            </div>
            <div className="flex flex-col min-w-0">
              <span className="font-extrabold text-sm sm:text-base text-slate-900 leading-tight tracking-tight whitespace-nowrap">
                {hospitalInfo.name || "City Care Hospital"}
              </span>
              <span className="text-[10px] text-blue-600 font-semibold tracking-wide uppercase hidden sm:block">
          ...
          <div className="flex items-center space-x-1.5 sm:space-x-2 shrink-0">
            <button
              ...
              className="bg-emerald-600 hover:bg-emerald-700 text-white px-2.5 sm:px-3 py-1.5 rounded-xl font-bold text-xs shadow-sm transition-all flex items-center gap-1.5 shrink-0 active:scale-95 cursor-pointer whitespace-nowrap"
            >
            ...
            <button
              ...
              className="px-2 sm:px-2.5 py-1.5 text-xs font-bold text-slate-700 hover:text-blue-600 hover:bg-slate-100 rounded-xl transition-all flex items-center gap-1 shrink-0 cursor-pointer whitespace-nowrap"
            >
            ...
            <button
              ...
              className="hidden md:flex bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white px-3 sm:px-3.5 py-1.5 rounded-xl font-bold text-xs shadow-md shadow-blue-600/20 hover:shadow-lg transition-all active:scale-[0.98] shrink-0 items-center gap-1 cursor-pointer whitespace-nowrap"
            >
            ...
            <button
              ...
              className="xl:hidden p-1.5 rounded-xl text-slate-700 hover:bg-slate-100 transition-colors shrink-0 cursor-pointer ml-0.5"
